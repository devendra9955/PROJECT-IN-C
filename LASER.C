...
int projectwork1() // AMPLIFICATION
{
    setbkcolor(BLUE);
    setcolor(WHITE);
    circle(170, 230, 8);
    ...
    settextstyle(7, 0, 4);
    setcolor(WHITE);
    outtextxy(110, 300, "Amplification of photon");
    delay(1000);
...
int projectwork3()
{
    ...
    ellipse(460, 230, 90, 89, 15, 70); // semi silevered mirror
    setfillstyle(1, CYAN);
    floodfill(465, 232, WHITE);

    rectangle(300, 365, 360, 380); // power source
    setfillstyle(1, RED);
    floodfill(385, 370, WHITE);
